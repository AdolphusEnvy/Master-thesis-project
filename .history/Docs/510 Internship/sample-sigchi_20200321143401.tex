...
The LOFAR consists of 51 stations cross the Europe and a typical LOFAR observation has the size of 100TB, after friquency averaing, the size can be reduced to 16TB. 
Collectivly, there are over 5 PB of data will be stored each year. \cite{Mathioudakis2010}
