...
All of them have achived great acceleration compared to naive version. In this project, we try to tackle on one common issue, dynamic management of resources, stemming from parallel solutions like MPI and Spark. 
