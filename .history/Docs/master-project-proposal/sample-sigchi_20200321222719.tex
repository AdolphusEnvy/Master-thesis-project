...
All of them have achived great acceleration compared to naive version. 

However, the solutions following horizental scaling idea,MPI and Spark, will lead to waste of computation resources in non-dedicated clusters.
In this project, we try to build up a system to achive auto provisioning at public cluster to dirve the computation comsuming applications. This solution can be applied to other more distributed/parallel systems.
