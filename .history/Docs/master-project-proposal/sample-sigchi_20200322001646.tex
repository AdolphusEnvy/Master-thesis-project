...
In this project, we try to build up a system to achive auto provisioning at public cluster to dirve the computation comsuming applications. This solution can be applied to other more applications with the demond of auto-provisioning.
