...
In our case, the executors are based on containers. It is more light weight than VMs.

\subsection{Xenon}
Xenon is a middleware developed by eScience Center that tends to provide a single programming interface.
