...
//        RequestBody body=FormBody.create("{\"miniNode\":"+recommandMiniNode+"}",JSON);
    ...
    public static String submitJob(String serviceAddress,OkHttpClient client,String submitString) {
        ...
        Request request=new Request.Builder().url(serviceAddress).put(body).build();
        try (Response response=client.newCall(request).execute()){
            return Objects.requireNonNull(response.body()).string();
        }catch (Exception e)
        {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String submitString="{\"location\":\"/home/yhu310/Calibration\",\"user\":\"yhu310\",\"parameter\":\"-d FILE_DIR -s 3c196.sky.txt -c 3c196.sky.txt.cluster -n 4 -t 10 -p sm.ms.solutions -e 4 -g 2 -l 10 -m 7 -x 30 -F 1 -j 5  -k -1 -B 1 -W 0\",\"executable\":\"/opt/sagecal/bin/sagecal\",\"Job\":\"Sagecal\"}";
